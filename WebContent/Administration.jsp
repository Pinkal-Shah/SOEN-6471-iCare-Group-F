...
<button class="btn btn-danger" data-target="#deleteDoctor">Delete</button>
</div>
...
<!-- Doctor Delete Modal -->
<div class="modal fade" id="deleteDoctor" tabindex="0" role="dialog">
 <div class="modal-dialog" role="document">
<div class="modal-content">
 <div class="modal-header">
<h5 class="modal-title">Delete a Doctor</h5>
<button type="button" class="close" data-dismiss="modal" aria-label="Close">
 <span aria-hidden="true">&times;</span>
</button>
 </div>
...
<form action="DeleteServlet" method="POST">
 <div class="form-group">
<label for="labelInputFirstName">Please conform the doctor name</label>
<input type="text" class="form-control" id="Name" placeholder="Doctor Name">
 </div>
 <div class="modal-footer">
<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
<button type="button" class="btn btn-primary" value="deleteBtn">Delete</button>
 </div>
 </div>
</div>
 </div>
