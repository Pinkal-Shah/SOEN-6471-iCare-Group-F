...
public class ViewServlet extends HttpServlet {  
    protected void doGet(HttpServletRequest request, HttpServletResponse response)   
		 ...
		 * 
		 * out.print("<table border='1' width='100%'"); out.print(
		 ...
		 * getPassword()+"</td><td>"+e.getEmail()+"</td><td>"+e.getCountry()
		 * +"</td><td><a href='EditServlet?id="+e.getId()
		 * +"'>edit</a></td><td><a href='DeleteServlet?id="+e.getId()+
		 * "'>delete</a></td></tr>"); } out.print("</table>");
		 * 
		 * out.close();
		 */
    }  
